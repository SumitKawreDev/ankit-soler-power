        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              {/* Facebook */}
              <a
                href="https://www.facebook.com/share/18NtFFPCSN/?mibextid=wwXIfr"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-[#023d2a] rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:bg-[#035238] group"
                aria-label="Facebook"
              >
                <svg className="w-5 h-5 text-white transition-colors duration-300 group-hover:text-green-300" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/ankit_solar_solutions_?igsh=Z2M5bW82ejR0djRh"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-[#023d2a] rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:bg-[#035238] group"
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+919479369947" className="text-green-200 hover:text-accent text-sm transition-colors">+91 9479369947</a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <a href="mailto:Aspgreenenergy.tata01@gmail.com" className="text-green-200 hover:text-accent text-sm transition-colors">Aspgreenenergy.tata01@gmail.com</a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-green-200 text-sm">Ward Number 22, MIG II 59, Deendayal Puram, Balaghat, Madhya Pradesh 481001</p>
                </div>
              </li>
            </ul>
          </div>
      ...
      <div className="border-t border-primary">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-5 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-green-400 text-sm">
            &copy; 2018 Ankit Solar Power. All rights reserved.
          </p>
