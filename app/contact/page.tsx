                ...
                <div className="container-max">
                    <div className="grid lg:grid-cols-3 gap-10">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    {(category === 'commercial' || category === 'residential') && (
                                        <div>
                                            ...
                                            <input type="text" name="companyName" value={form.companyName} onChange={handleChange} placeholder="Business Name"
                                                className="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary" />
                                        </div>
                                    )}
                                    ...
                                    {category === 'franchise' && (
                                        <div>
                                            ...
                                            <input type="text" name="occupation" value={form.occupation} onChange={handleChange} placeholder="Your current profession or business type"
                                                className="w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary" />
                                        </div>
                                    )}
                                        ...
                                        <div>
                                            ...
                                            {!electricityBill ? (
                                                <div
                                                    ...
                                                    className="relative border-2 border-dashed border-gray-300 rounded-xl p-6 text-center cursor-pointer hover:border-primary hover:bg-primary/5 transition-all group"
                                                >
                                                    <input
                                                        ref={fileInputRef}
                                                        type="file"
                                                    ...
                                                    {/* Upload Icon */}
                                                    <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:bg-primary/10 transition-colors">
                        ...
                        <div className="space-y-6">
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <a href="tel:+919479369947" className="text-gray-900 font-medium text-sm hover:text-primary transition-colors block">+91 9479369947</a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <a href="https://wa.me/918103917980" target="_blank" rel="noopener noreferrer" className="text-gray-900 font-medium text-sm hover:text-green-600 transition-colors block">+91 8103917980</a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:Aspgreenenergy.tata01@gmail.com" className="text-gray-900 font-medium text-sm hover:text-primary transition-colors block">Aspgreenenergy.tata01@gmail.com</a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="text-xs text-gray-400 mb-0.5">Office Address</p>
                                            <p className="text-gray-900 font-medium text-sm">Ward Number 22, MIG II 59</p>
                                            <p className="text-gray-900 font-medium text-sm">Deendayal Puram, Balaghat,</p>
                                            <p className="text-gray-900 font-medium text-sm"> Madhya Pradesh 481001</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="pt-4 border-t border-gray-200">
                                        ...
                                        <div className="flex items-center gap-3">
                                            <a href="https://www.facebook.com/share/18NtFFPCSN/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-blue-600 hover:bg-blue-700 rounded-xl flex items-center justify-center transition-colors" aria-label="Facebook">
                                                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                                </svg>
                                            </a>
                                            <a href="https://www.instagram.com/ankit_solar_solutions_?igsh=Z2M5bW82ejR0djRh" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 hover:opacity-90 rounded-xl flex items-center justify-center transition-opacity" aria-label="Instagram">
                                                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                            ...
                                            {/* <a href="https://linkedin.com/company/ankitsolar" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-blue-700 hover:bg-blue-800 rounded-xl flex items-center justify-center transition-colors" aria-label="LinkedIn">
                                                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {/* Map Preview Card */}
                            <div className="rounded-2xl overflow-hidden border border-gray-200 shadow-sm relative group cursor-pointer"
                                 onClick={() => window.open('https://maps.app.goo.gl/ugNEBc7dT8yTBwr56', '_blank')}
                            >
                                {/* Map Image */}
                                <div className="relative">
                                    <img
                                        src="/images/map-preview.png"
                                        alt="Office Location - Deendayal Puram, Balaghat, Madhya Pradesh"
                                        className="w-full h-[280px] object-cover group-hover:scale-[1.02] transition-transform duration-500"
                                    ...
                                    <a
                                        href="https://maps.app.goo.gl/ugNEBc7dT8yTBwr56"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        onClick={(e) => e.stopPropagation()}
                                        className="absolute top-3 left-3 inline-flex items-center gap-2 bg-white/95 backdrop-blur-sm hover:bg-white text-gray-800 font-semibold px-4 py-2.5 rounded-xl transition-all shadow-md hover:shadow-lg text-sm border border-gray-100"
                                    >
