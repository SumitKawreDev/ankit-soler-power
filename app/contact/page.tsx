                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <a href="tel:+919876543210" className="text-gray-900 font-medium text-sm hover:text-primary transition-colors block">+91 98765 43210</a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="text-gray-900 font-medium text-sm hover:text-green-600 transition-colors block">+91 98765 43210</a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:info@ankitsolar.com" className="text-gray-900 font-medium text-sm hover:text-primary transition-colors block">info@ankitsolar.com</a>
                                            <a href="mailto:support@ankitsolar.com" className="text-gray-600 font-medium text-sm hover:text-primary transition-colors block">support@ankitsolar.com</a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-900 font-medium text-sm">123 Solar Energy Park</p>
                                            <p className="text-gray-600 text-sm">Sector 15, Gurugram</p>
                                            <p className="text-gray-600 text-sm">Haryana - 122001, India</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="pt-4 border-t border-gray-200">
                                        ...
                                        <div className="flex items-center gap-3">
                                            <a href="https://facebook.com/ankitsolar" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-blue-600 hover:bg-blue-700 rounded-xl flex items-center justify-center transition-colors" aria-label="Facebook">
                                                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                                </svg>
                                            </a>
                                            <a href="https://instagram.com/ankitsolar" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 hover:opacity-90 rounded-xl flex items-center justify-center transition-opacity" aria-label="Instagram">
                                                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
